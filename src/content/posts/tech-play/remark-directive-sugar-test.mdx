...
modDatetime: 2026-09-12T23:32:20.000+08:00
title: 博客常用语法测试
featured: false
draft: false
tags:
...
> [!WARNING]
> 本文部分测试用的代码块内容为AI生成，目的是快速测试功能是否可以使用并存档
...
<figure>
  <img src="https://images.pexels.com/photos/237272/pexels-photo-237272.jpeg" class="w-1/2 mx-auto" />
  <figcaption>这是一张带题注的图片，支持 **Markdown** 语法。~~说实话我也不知道为什么会支持~~</figcaption>
</figure>
...
这是一个 <Term>富文本术语<Fragment slot="annotation">这是<b>加粗</b>
 的注解，含一个 <a href="https://example.com" class="underline">链接</a> 和 <code> some code </code></Fragment></Term> 的例子。
...
分别为单下划线和双下划线，分别有4px和3px的距离，而不是和中文文本脸贴脸，可能英文看上不贴吧

```html
<u>我需要强调这句话</u>
<u title="类似于注解">一个类似于注解的下划线语法</u>
```
...
```html
谁不想要一个<span class="em">沾上去就会睡着的枕头</span>呢
```
